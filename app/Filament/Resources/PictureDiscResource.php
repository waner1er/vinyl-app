...
use App\Filament\Resources\PictureDiscResource\Pages;
...
class PictureDiscResource extends Resource
{
    protected static ?string $model = PictureDisc::class;
    ...
    {
        return [
            'index' => Pages\ListPictureDiscs::route('/'),
            'create' => Pages\CreatePictureDisc::route('/create'),
            'edit' => Pages\EditPictureDisc::route('/{record}/edit'),
        ];
    }
}
